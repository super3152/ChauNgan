...
public class BLLHoaDon {
 ...
 public static void DoDuLieuVaoCBBTenNguoiDung(JComboBox cbb) {
    ...
    public static double NhapSanPhamVaoChiTietHoaDon(JTable tb, DTOSanPham sp, int SoLuong, double UuDai) {
      ...
      public static double NhapSanPhamVaoChiTietHoaDonMoi(JTable tb, DTOSanPham sp, int SoLuong, double UuDai) {
        pnldonbanhang.tblChiTietHoaDon1.getColumn("Ảnh").setCellRenderer(new BLLSanPham.mytable());
    ...
    public static double NhapSanPhamVaoChiTietHoaDonTrung(JTable tb, DTOSanPham sp, int SoLuong, double UuDai) {
     ...
     public static double NhapSanPhamVaoChiTietHoaDonTrungMoi(JTable tb, DTOSanPham sp, int SoLuong, double UuDai) {
        pnldonbanhang.tblChiTietHoaDon1.getColumn("Ảnh").setCellRenderer(new BLLSanPham.mytable());
