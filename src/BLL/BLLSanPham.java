...
public class BLLSanPham {
    ...
    public static DTO.DTOSanPham sp = new DTOSanPham();
     public static void SizeSanPhamTheoTen(JComboBox cbbSizeSanPham, String TenSP) {
       ...
       public static void HienThiSanPhamLoc(JTable tbl, int trang, String MaLoaiSP, String MaHangSP, String MaKe, String MaSize, String MaMau) {
        ...
        ResultSet rs = DAO.DAOSanPham.LaySanPhamLoc(trang, MaLoaiSP, MaHangSP, MaKe, MaSize, MaMau);
